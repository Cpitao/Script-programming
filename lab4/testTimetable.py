...
class Test_Timetable(unittest.TestCase):
    ...
    def test_shifting(self):
        ...
        lesson1 = Lesson(timetable, term1, "Podstawy eksploatacji złóż gazu", "Janusz Kowalski", 2, True)
        lesson2 = Lesson(timetable, term2, "Podstawy gazownictwa ziemnego", "Janusz Kowalski", 2, True)
        timetable.perform(timetable.parse(["t-", "d-", "t+", "d-"]))
        self.assertTrue(lesson1.term == Term(Day.TUE, 9, 30))
    ...
    def test_put_invalid(self):
        ...
        term1 = Term(Day.TUE, 9, 30)
        lesson1 = Lesson(timetable, term1, "Podstawy eksploatacji złóż gazu", "Janusz Kowalski", 2, True)
        lesson2 = Lesson(timetable, term1, "Podstawy eksploatacji złóż gazu", "Janusz Kowalski", 2, True)
